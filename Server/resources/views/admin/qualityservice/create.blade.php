...
@section('title','Add Quality Service')
@section('content')
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h2>Add Quality Service of {{ \App\Service::where('id', $id)->first()?->title }}</h2>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form role="form" method="post" action="{{ route('qualityservice.store') }}" enctype="multipart/form-data">
                                        @csrf
